class SimpleChat {
    constructor () {
        ...
        this.inputMessage.onchange = function ( event ) {
            ...
            fetch ( "http://localhost:5000/lastUpdate", {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json"
                },
    ...
    addElement ( tagName, cont ) {
        console.log(tagName, cont);
         let container = cont && cont.nodeType === 1 ?
             cont : document.body;
    ...
    getData ( ref ) {
        return fetch ( `http://localhost:5000/${ref}` )
    ...
    async getAllData () {
        ...
        if ( this.currentUser ) {
            ...
            fetch ( `http://localhost:5000/users/${this.currentUser.id}`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json"
                },
    ...
    static closeChat () {
        ...
        fetch ( `http://localhost:5000/users/${this.instance.currentUser.id}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json"
            },
